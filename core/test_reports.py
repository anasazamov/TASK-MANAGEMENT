...
class EmployeeReportTests(TestCase):
    ...
    def test_head_sees_only_visible_employees_and_tasks(self):
        ...
        self.assertEqual({r['assignee_id'] for r in reports.employee_stats(self.chair)}, {self.employee.pk, self.other.pk})
    ...
    def test_excel_download_has_sample_layout(self):
        ...
        self.assertEqual(sheet['C10'].value, self.chair.short_name)
